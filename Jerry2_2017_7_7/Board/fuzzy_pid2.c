...
//输出P值表
//480, 490, 500, 510, 530, 550, 570 早上的
int16 UP0[7] = {460, 470, 480, 490, 510, 530, 550}; //OK
int16 UP1[7] = {530, 540, 550, 560, 570, 580, 590}; 
int16 UP2[7] = {500, 510, 520, 530, 540, 550, 560};
int16 UP3[7] = {510, 520, 530, 540, 550, 560, 570};
int16 UP4[7] = {470, 480, 490, 500, 510, 520, 530};
int16 UP5[7] = {460, 470, 480, 490, 500, 510, 520};
...
//int16 UFF1[7] = {  70, 74, 77, 80, 83, 86  ,105};// 对于比较滑的赛道
//int16 UFF1[7] = {  75, 79, 82, 85, 88, 92  ,110};
//{600, 620, 640, 660, 670, 680, 690}
//77, 81, 84, 87, 90, 94  ,112
int16 UFF0[7] = {  60, 65, 68, 71, 74, 80, 98};
int16 UFF1[7] = {  65, 70, 73, 76, 79, 85, 102};

int16 UFF2[7] = {  65, 70, 73, 76, 79, 85, 102 };
int16 UFF3[7] = {  70, 74, 77, 80, 83, 87  ,105 }; 


int16 UFF4[7] = {  70, 74, 77, 80, 83, 87  ,105 };
int16 UFF5[7] = {  75, 79, 82, 85, 88, 92  ,110 }; 
//int16 UFF4[7] = {  75, 79, 82, 85, 88, 92  ,110 };
//int16 UFF5[7] = {  80, 84, 87, 90, 93, 97, 115}; 
