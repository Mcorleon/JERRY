...
//输出P值表
int16 UP0[7] = {450, 480, 520, 560, 580, 600, 620}; 
int16 UP1[7] = {450, 490, 530, 570, 600, 620, 650}; //大S欧姆都不错，出十字和圆环都会切一下路肩
int16 UP2[7] = {450, 490, 530, 560, 600, 620, 650};
int16 UP3[7] = {450, 480, 510, 540, 560, 580, 600};
int16 UP4[7] = {480, 520, 550, 580, 600, 620, 650};//大S还行 十字有点内切
...
int16 UD3[7] = {80, 85, 90, 100, 110, 120, 130}; 
                                                  //双车跟随:
...
int16 UFF1[7] = {  70, 73, 76, 79, 82, 85  ,105};//中档
int16 UFF2[7] = {  78, 80, 83, 86, 89, 92, 112  };//快档

int16 UFF3[7] = {  88, 90, 93, 96, 99, 102, 120}; 
int16 UFF4[7] = {  93, 96, 99, 102, 105, 108, 122}; 
int16 UFF5[7] = {  90, 93, 96, 99, 102, 105, 115 };////能跑 路径不行 
int16 UFF6[7] = {  93, 96, 99, 102, 105, 108, 122 };//抓地力明显不足了 但过环还可以
int16 *UP = UP0;
int16 *UD = UD0;
int16 *UFF = UFF0; 
