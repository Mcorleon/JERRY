...
//输出P值表
int16 UP0[7] = {450, 480, 520, 560, 600, 620, 650}; 
int16 UP1[7] = {500, 550, 600, 640, 660, 680, 700}; 
int16 UP2[7] = {500, 540, 580, 620, 640, 660, 680};
int16 UP3[7] = {480, 520, 560, 600, 620, 650, 680};
int16 UP4[7] = {480, 500, 550, 610, 630, 660, 690};
...
int16 UD3[7] = {100, 125, 140, 150, 165, 180, 190}; 
                                                  //双车跟随:
